...
\chapterheader{۸}{فاز ۱: گذار}{عبور امن از پرتگاه بحران}{EraEarlyMod}
\label{chap:phase1}
...
\begin{tikzpicture}[
    ...
    committee/.style={
        ...
        draw=goldphoenix,
        fill=goldlight,
        minimum width=2.2cm, text width=2.2cm,
...
% مرکز
\node[circle, minimum size=2cm, text width=2cm, draw=goldphoenix, fill=goldphoenix, text=white, font=\tiny\bfseries] (treasury) at (5,0) {\rl{خزانه دولت}};
...
\node[rectangle, rounded corners=6pt, draw=black!70, fill=black!10,
      minimum width=4cm, text width=4cm, minimum height=1.5cm, font=\small\bfseries,
...
\node[rectangle, rounded corners=4pt, draw=teal!70, fill=teal!15,
      minimum width=3cm, text width=3cm, minimum height=1cm, font=\scriptsize\bfseries,
...
% کمیسیون مرکزی
\node[unit=purple, minimum width=5cm, text width=5cm, minimum height=1.8cm] (main) at (0,4) {
    \begin{tabular}{c}
    کمیسیون حقیقت‌یاب\\
...
% دفاتر استانی
\node[unit=gray, minimum width=10cm, text width=10cm] (regional) at (0,-0.5) {
    \begin{tabular}{c}
...
% ریسک‌ها
\node[circle, fill=red!70, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=white] 
    at (axis cs:50,90) {R1};
\node[circle, fill=purple!70, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=white] 
    at (axis cs:25,85) {R2};
\node[circle, fill=orange!70, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=white] 
    at (axis cs:75,75) {R3};
\node[circle, fill=red!60, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=white] 
    at (axis cs:50,70) {R4};
\node[circle, fill=orange!60, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=white] 
    at (axis cs:55,65) {R5};
\node[circle, fill=yellow!70, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=black] 
    at (axis cs:30,50) {R6};
\node[circle, fill=yellow!60, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=black] 
    at (axis cs:70,55) {R7};
\node[circle, fill=orange!50, minimum size=0.4cm, text width=0.4cm, font=\tiny\bfseries, text=white] 
    at (axis cs:75,50) {R8};
...
\node[rectangle, rounded corners=8pt, draw=purple!70, fill=purple!10,
      minimum width=6cm, text width=6cm, minimum height=1.5cm, font=\small\bfseries,
