...
\chapterheader{۱}{مقدمه: چرا این کتاب؟}{فهم ضرورت گذار در لحظه تاریخی}{PrimaryMid}
...
\begin{tikzpicture}[
    ...
    center/.style={
        circle,
        minimum size=2.5cm, text width=2.5cm,
        align=center,
        font=\small\bfseries,
        draw=black,
        fill=grislight,
...
\node[crisis] (c1) at (90:3.5cm) {
    \begin{tabular}{c}
    \rl{بحران آب}\\
    {\scriptsize \rl{فروپاشی سفره‌ها}}
    \end{tabular}
};
\node[crisis] (c2) at (30:3.5cm) {
    \begin{tabular}{c}
    \rl{بحران اقتصادی}\\
    {\scriptsize \rl{تحریم + تورم}}
    \end{tabular}
};
\node[crisis] (c3) at (330:3.5cm) {
    \begin{tabular}{c}
    \rl{بحران سیاسی}\\
    {\scriptsize \rl{انسداد + فساد}}
    \end{tabular}
};
...
% تلفیق
\node[mainbox, draw=violetempire, fill=violetlight, minimum width=5cm, text width=5cm, minimum height=2.5cm] (d) at (5,0) {
    \begin{tabular}{c}
...
% نتایج
\node[mainbox, draw=rougerevolution, fill=rougelight, minimum width=2.5cm, text width=2.5cm, minimum height=1.2cm] (e1) at (1,-3) {
    \begin{tabular}{c}
    مشروعیت
    \end{tabular}
};
\node[mainbox, draw=phase2, fill=phase2!20, minimum width=2.5cm, text width=2.5cm, minimum height=1.2cm] (e2) at (5,-3) {
    \begin{tabular}{c}
    کارآمدی
    \end{tabular}
};
\node[mainbox, draw=phase4, fill=phase4!20, minimum width=2.5cm, text width=2.5cm, minimum height=1.2cm] (e3) at (9,-3) {
    \begin{tabular}{c}
    پایداری
    \end{tabular}
};
...
% وسط
\node[levelbox, draw=violetempire, fill=violetlight, minimum width=6cm, text width=6cm, minimum height=2cm] (mid) at (0,0) {
    \begin{tabular}{c}
...
\begin{tikzpicture}[
    ...
    partbox/.style={
        rectangle,
        rounded corners=3pt,
        minimum width=13cm, text width=13cm,
    ...
    chapbox/.style={
        rectangle,
        minimum width=5.5cm, text width=5.5cm,
