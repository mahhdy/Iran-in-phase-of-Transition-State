...
% قبل
\node[levelbox, draw=rougerevolution, fill=rougelight] (before) at (-4,0) {\rl{قبل از ۱۹۹۹}\\{\tiny تمرکز شدید}};
\node[levelbox, draw=bleurepublique, fill=bleulight] (after) at (4,0) {\rl{بعد از ۱۹۹۹}\\{\tiny تمرکززدایی}};
