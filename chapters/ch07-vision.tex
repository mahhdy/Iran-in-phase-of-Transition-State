...
\begin{tabular}{>{\columncolor{blue!8}}r p{3.2cm} p{4.5cm} p{3.5cm}}
\toprule
\rowcolor{blue!25}
\textbf{ردیف} & \textbf{رکن چشم‌انداز} & \textbf{شاخص موفقیت} & \textbf{وضعیت کنونی ایران} \\
\midrule
۱ & حقوق برابر شهروندی & شاخص برابری جنسیتی > ۰.۸ & ۰.۵۷ (رتبه ۱۴۳ جهان) \\
\rowcolor{gray!10}
۲ & حکومت پاسخگو & شاخص دموکراسی > ۷ & ۱.۹۶ (رتبه ۱۵۴ جهان) \\
۳ & خودمدیریت اقوام & رضایت قومی > ۷۵٪ & داده معتبر موجود نیست \\
\rowcolor{gray!10}
۴ & احیای محیط زیست & سطح سفره‌های آب > ۸۰٪ & ۴۵٪ و کاهنده \\
۵ & اقتصاد متنوع & سهم نفت از صادرات < ۲۰٪ & ۷۲٪ \\
\rowcolor{gray!10}
۶ & عضویت محترم جهانی & پایان تحریم‌ها & ۳۸۰۰+ تحریم فعال \\
\bottomrule
\end{tabular}
\end{table}
...
% اصول - دایره بیرونی
\node[principle=blue] (p1) at (90:4.5) {
    \begin{tabular}{c}
    ۱. حاکمیت ملی
    \end{tabular}
};
\node[principle=teal] (p2) at (54:4.5) {
    \begin{tabular}{c}
    ۲. کثرت‌گرایی
    \end{tabular}
};
\node[principle=green] (p3) at (18:4.5) {
    \begin{tabular}{c}
    ۳. عدالت توزیعی
    \end{tabular}
};
\node[principle=lime] (p4) at (-18:4.5) {
    \begin{tabular}{c}
    ۴. حقوق بشر
    \end{tabular}
};
\node[principle=yellow] (p5) at (-54:4.5) {
    \begin{tabular}{c}
    ۵. پایداری محیطی
    \end{tabular}
};
\node[principle=orange] (p6) at (-90:4.5) {
    \begin{tabular}{c}
    ۶. تمرکززدایی
    \end{tabular}
};
\node[principle=red] (p7) at (-126:4.5) {
    \begin{tabular}{c}
    ۷. پاسخگویی
    \end{tabular}
};
\node[principle=pink] (p8) at (-162:4.5) {
    \begin{tabular}{c}
    ۸. صلح‌طلبی
    \end{tabular}
};
\node[principle=violet] (p9) at (162:4.5) {
    \begin{tabular}{c}
    ۹. حکمرانی علمی
    \end{tabular}
};
\node[principle=cyan] (p10) at (126:4.5) {
    \begin{tabular}{c}
    ۱۰. عدالت انتقالی
    \end{tabular}
};
...
\begin{tabular}{>{\columncolor{teal!8}}r l r r l}
\toprule
\rowcolor{teal!25}
\textbf{ردیف} & \textbf{گروه قومی} & \textbf{جمعیت (میلیون)} & \textbf{درصد} & \textbf{زبان اصلی} \\
\midrule
۱ & فارس & ۴۵-۵۰ & ۵۳-۵۹٪ & فارسی \\
\rowcolor{gray!10}
۲ & آذربایجانی & ۱۵-۲۰ & ۱۸-۲۴٪ & ترکی آذربایجانی \\
۳ & کُرد & ۷-۹ & ۸-۱۰٪ & کردی (سورانی/کرمانجی) \\
\rowcolor{gray!10}
۴ & لُر و بختیاری & ۵-۶ & ۶-۷٪ & لری/بختیاری \\
۵ & عرب & ۲-۳ & ۲-۴٪ & عربی \\
\rowcolor{gray!10}
۶ & بلوچ & ۲-۳ & ۲-۳٪ & بلوچی \\
۷ & ترکمن & ۱-۲ & ۱-۲٪ & ترکمنی \\
\rowcolor{gray!10}
۸ & سایر & ۲-۳ & ۲-۳٪ & متنوع \\
\midrule
\rowcolor{teal!15}
& \textbf{جمع} & \textbf{۸۵} & \textbf{۱۰۰٪} & \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{axis}[
    ...
    width=14cm,
    height=7cm,
    ylabel={درآمد سرانه (میلیون ریال/سال)},
    xlabel={استان},
    ymin=0,
    ymax=900,
    xtick=data,
...
\legend{درآمد سرانه استانی, میانگین کشوری}
\end{axis}
\end{tikzpicture}
\caption{نابرابری درآمد سرانه بین استان‌های ایران (۱۴۰۲)}
\label{fig:regional-inequality}
\end{figure}
...
\begin{tabular}{>{\columncolor{red!5}}r l c c c c}
\toprule
\rowcolor{red!20}
\textbf{ردیف} & \textbf{شاخص} & \textbf{ایران} & \textbf{ترکیه} & \textbf{آفریقای ج.} & \textbf{هدف ۱۴۲۹} \\
\midrule
۱ & آزادی مطبوعات (۱-۱۰۰) & ۱۷۶/۱۸۰ & ۱۴۹ & ۳۲ & زیر ۵۰ \\
\rowcolor{gray!10}
۲ & آزادی اینترنت (۱-۱۰۰) & ۱۶ & ۳۲ & ۵۸ & بالای ۶۰ \\
۳ & اعدام سالانه & ۵۸۰+ & ۰ & ۰ & ۰ \\
\rowcolor{gray!10}
۴ & زندانی سیاسی & ۱۰۰۰+ & ۴۰۰۰۰+ & زیر ۱۰ & ۰ \\
۵ & شکنجه (گزارش‌شده) & سیستماتیک & گسترده & موردی & ممنوع \\
\rowcolor{gray!10}
۶ & برابری جنسیتی & ۱۴۳/۱۴۶ & ۱۲۹ & ۲۰ & زیر ۵۰ \\
\bottomrule
\end{tabular}
\end{table}
...
% پیش‌بینی منابع (بدون اقدام)
\addplot[thick, dashed, color=blue!50] coordinates {
    (1403,88) (1410,75) (1420,60) (1429,50)
};
% پیش‌بینی مصرف (بدون اقدام)
\addplot[thick, dashed, color=red!50] coordinates {
    (1403,115) (1410,120) (1420,125) (1429,130)
};
% هدف با اصلاحات
\addplot[thick, dotted, color=green!70!black, mark=triangle*] coordinates {
    (1403,115) (1410,100) (1420,85) (1429,75)
};
\legend{
    منابع تجدیدپذیر (واقعی),
    مصرف (واقعی),
    منابع (بدون اقدام),
    مصرف (بدون اقدام),
    مصرف (با اصلاحات)
...
\node[level=orange] (regional) at (0,3) {
    \begin{tabular}{c}
    سطح منطقه‌ای\\
    (۵ منطقه)
    \end{tabular}
...
\node[level=green] (provincial) at (0,0) {
    \begin{tabular}{c}
    سطح استانی\\
    (۳۱ استان)
    \end{tabular}
...
% صلاحیت‌ها
\node[competence] (nat-comp) at (6,6) {
    دفاع و امنیت ملی\\
    سیاست خارجی\\
    پول و بانک مرکزی\\
    تجارت خارجی\\
...
\node[competence] (reg-comp) at (6,3) {
    هماهنگی توسعه منطقه‌ای\\
    مدیریت حوضه‌های آبریز\\
    زیرساخت‌های بین‌استانی\\
    نظارت بر استان‌ها
};

\node[competence] (prov-comp) at (6,0) {
    آموزش و پرورش\\
    بهداشت و درمان\\
    پلیس محلی\\
    زبان و فرهنگ محلی\\
...
\node[competence] (loc-comp) at (6,-3) {
    شهرسازی و مسکن\\
    حمل‌ونقل درون‌شهری\\
    آب و فاضلاب شهری\\
    فضای سبز و پارک‌ها
...
\draw[->, gray!50] (nat-comp.west) -- (national.east);
\draw[->, gray!50] (reg-comp.west) -- (regional.east);
\draw[->, gray!50] (prov-comp.west) -- (provincial.east);
\draw[->, gray!50] (loc-comp.west) -- (local.east);

% عنوان صلاحیت‌ها
\node[above, font=\small\bfseries] at (6,7) {صلاحیت‌های انحصاری};

\end{tikzpicture}
\caption{ساختار فدرالیسم همبسته و تقسیم صلاحیت‌ها}
\label{fig:federalism-structure}
\end{figure}
...
\begin{tabular}{>{\columncolor{orange!8}}r l c c l}
\toprule
\rowcolor{orange!25}
\textbf{رتبه جهانی} & \textbf{کشور} & \textbf{امتیاز (از ۱۰۰)} & \textbf{تغییر ۱۰ ساله} & \textbf{وضعیت} \\
\midrule
۲۵ & امارات & ۶۸ & +۵ & خوب \\
\rowcolor{gray!10}
۵۵ & ترکیه & ۳۶ & -۴ & متوسط \\
۸۳ & هند & ۴۰ & +۲ & متوسط \\
\rowcolor{gray!10}
۱۴۹ & ایران & ۲۴ & -۳ & بسیار بد \\
۱۵۴ & عراق & ۲۳ & +۵ & بسیار بد \\
\rowcolor{gray!10}
۱۷۱ & افغانستان & ۱۶ & -۸ & فاجعه \\
\midrule
\rowcolor{green!15}
— & \textbf{هدف ایران ۱۴۲۹} & \textbf{۵۰+} & — & خوب \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tikzpicture}[scale=0.7, transform shape]
    % ایران - مرکز
    \fill[blue!30, draw=blue!60, thick] (0,0) ellipse (2.5 and 1.8);
    \node[font=\large\bfseries, text=blue!80] at (0,0) {ایران};
    
    % همسایگان - دایره
    \node[circle, fill=green!20, draw=green!60, minimum size=1.5cm, font=\small] 
        (tur) at (120:4.5) {ترکیه};
    \node[circle, fill=green!20, draw=green!60, minimum size=1.5cm, font=\small] 
        (arm) at (150:4) {ارمنستان};
    \node[circle, fill=green!20, draw=green!60, minimum size=1.5cm, font=\small] 
        (aze) at (90:4) {آذربایجان};
    \node[circle, fill=yellow!30, draw=yellow!70, minimum size=1.5cm, font=\small] 
        (tur2) at (60:4.5) {ترکمنستان};
    \node[circle, fill=red!20, draw=red!60, minimum size=1.5cm, font=\small] 
        (afg) at (30:4.5) {افغانستان};
    \node[circle, fill=red!20, draw=red!60, minimum size=1.5cm, font=\small] 
        (pak) at (-30:4.5) {پاکستان};
    \node[circle, fill=yellow!30, draw=yellow!70, minimum size=1.5cm, font=\small] 
        (uae) at (-60:4.5) {امارات};
    \node[circle, fill=red!20, draw=red!60, minimum size=1.5cm, font=\small] 
        (irq) at (-120:4.5) {عراق};
    \node[circle, fill=yellow!30, draw=yellow!70, minimum size=1.5cm, font=\small] 
        (sau) at (-150:4) {عربستان};
    
    % خطوط ارتباطی
    \foreach \neighbor in {tur,arm,aze,tur2,afg,pak,uae,irq,sau} {
        \draw[gray!40, thick] (0,0) -- (\neighbor);
    }
    
    % راهنما
    \node[fill=green!20, draw=green!60, minimum width=0.5cm, minimum height=0.3cm] at (6,3) {};
    \node[anchor=west, font=\scriptsize] at (6.4,3) {روابط خوب};
    \node[fill=yellow!30, draw=yellow!70, minimum width=0.5cm, minimum height=0.3cm] at (6,2.4) {};
    \node[anchor=west, font=\scriptsize] at (6.4,2.4) {روابط پیچیده};
    \node[fill=red!20, draw=red!60, minimum width=0.5cm, minimum height=0.3cm] at (6,1.8) {};
    \node[anchor=west, font=\scriptsize] at (6.4,1.8) {روابط پرتنش};
\end{tikzpicture}
\caption{وضعیت روابط ایران با همسایگان (۱۴۰۳)}
\label{fig:neighbor-relations}
\end{figure}
...
\node[element=blue] (truth) at (0,3) {
    \begin{tabular}{c}
    کشف حقیقت\\
    \small کمیسیون حقیقت‌یاب
    \end{tabular}
};

\node[element=red] (justice) at (5,3) {
    \begin{tabular}{c}
    محاکمه عادلانه\\
    \small دادگاه‌های ویژه
    \end{tabular}
};

\node[element=green] (repair) at (5,0) {
    \begin{tabular}{c}
    جبران خسارت\\
    \small غرامت به قربانیان
    \end{tabular}
};

\node[element=orange] (reform) at (0,0) {
    \begin{tabular}{c}
    اصلاح نهادها\\
    \small تطهیر و بازسازی
    \end{tabular}
};

% مرکز
\node[circle, draw=purple!70, fill=purple!10, minimum size=2.2cm, 
      font=\small\bfseries, text=purple!70, align=center] 
      (center) at (2.5,1.5) {
    \begin{tabular}{c}
    آشتی\\
    ملی
...
\draw[arrow, purple!40] (truth) -- (center);
\draw[arrow, purple!40] (justice) -- (center);
\draw[arrow, purple!40] (repair) -- (center);
\draw[arrow, purple!40] (reform) -- (center);

\end{tikzpicture}
\caption{چهار رکن عدالت انتقالی و هدف نهایی آشتی ملی}
\label{fig:transitional-justice-pillars}
\end{figure}
...
% رأی مردم
\node[ellipse, draw=cyan!70, fill=cyan!10, minimum width=3cm, minimum height=1cm,
...
\node[rectangle, rounded corners=3pt, draw=purple!60, fill=purple!10,
      minimum width=14cm, minimum height=0.8cm, font=\small\bfseries,
...
% مرکز
\node[circle, draw=red!60, fill=red!10, minimum size=1.5cm,
...
% فازها
\node[phase=red, minimum width=2.8cm] at (1.5,1.5) {
    \begin{tabular}{c}
    فاز ۱\\
    گذار\\
    (سال ۱-۲)
...
\node[phase=orange, minimum width=3.8cm] at (5,1.5) {
    \begin{tabular}{c}
    فاز ۲\\
    نهادسازی\\
    (سال ۳-۵)
...
\node[phase=yellow, minimum width=4.8cm] at (9.5,1.5) {
    \begin{tabular}{c}
    فاز ۳\\
    تحکیم\\
    (سال ۶-۱۰)
...
\node[phase=green, minimum width=3.8cm] at (14,1.5) {
    \begin{tabular}{c}
    فاز ۴\\
    بلوغ\\
    (سال ۱۱-۱۵)
...
\node[phase=blue, minimum width=3.8cm] at (18,1.5) {
    \begin{tabular}{c}
    فاز ۵\\
    تعالی\\
    (سال ۱۶-۲۵)
...
% اتصال به فصول بعدی
\node[box=red, minimum width=12cm] (next) at (6,-3) {
    \begin{tabular}{c}
