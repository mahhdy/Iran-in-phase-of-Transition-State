...
\chapterheader{۱۳}{توسعه اقتصادی}{اقتصادی پویا برای رفاه هر ایرانی}{SuccessGreen}
\label{ch:economy}
...
% اتصال به مرکز
\node[ellipse, draw=goldphoenix, fill=goldlight, thick, minimum width=2.8cm, text width=2.8cm] at (0,0.7) (center) 
    {\textbf{بحران اقتصادی}};
...
% مسیرها
\node[circle, draw=goldphoenix, fill=goldlight, minimum size=0.9cm, text width=0.9cm] (n1) at (-5,0) {\scriptsize اروپا};
\node[circle, draw=goldphoenix, fill=goldlight, minimum size=0.9cm, text width=0.9cm] (n2) at (5,0) {\scriptsize چین};
\node[circle, draw=goldphoenix, fill=goldlight, minimum size=0.9cm, text width=0.9cm] (n3) at (0,2) {\scriptsize روسیه};
\node[circle, draw=goldphoenix, fill=goldlight, minimum size=0.9cm, text width=0.9cm] (n4) at (0,-2) {\scriptsize هند};
\node[circle, draw=goldphoenix, fill=goldlight, minimum size=0.9cm, text width=0.9cm] (n5) at (-3,-1.5) {\scriptsize خلیج فارس};
\node[circle, draw=goldphoenix, fill=goldlight, minimum size=0.9cm, text width=0.9cm] (n6) at (3,1.5) {\scriptsize میانه};

% ایران در مرکز
\node[rectangle, rounded corners, draw=bleurepublique, fill=goldphoenix, text=white, minimum width=2cm, text width=2cm, minimum height=1cm] (iran) at (0,0) {\textbf{ایران}};
...
\node[rectangle, rounded corners=10pt, draw=blue!70, fill=blue!20,
      thick, minimum width=2.5cm, text width=2.5cm, minimum height=1.5cm, text width=2.5cm, align=center] (iran) 
