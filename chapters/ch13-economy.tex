...
% چرخه مثبت
\node[box=green] (econ) {\textbf{اقتصاد سالم}\\ رشد، اشتغال، ثبات};
\node[box=blue, right=2.5cm of econ] (legit) {\textbf{مشروعیت}\\ اعتماد به نظام جدید};
\node[box=purple, below=2cm of legit] (stab) {\textbf{ثبات سیاسی}\\ امکان اصلاحات بیشتر};
\node[box=orange, below=2cm of econ] (invest) {\textbf{سرمایه‌گذاری}\\ داخلی و خارجی};
...
\begin{tabular}{>{\columncolor{red!8}}r l c c p{3cm}}
\toprule
\rowcolor{red!25}
\textbf{ردیف} & \textbf{شاخص} & \textbf{مقدار} & \textbf{رتبه جهانی} & \textbf{وضعیت} \\
\midrule
...
۵ & نرخ بیکاری (رسمی) & ۱۲٪ & — & بالا \\
\rowcolor{gray!10}
۶ & بیکاری جوانان & ۲۸٪ & — & بحرانی \\
۷ & نرخ فقر & ۳۰٪+ & — & بالا \\
\rowcolor{gray!10}
۸ & ضریب جینی & ۰.۴۲ & — & نابرابری بالا \\
۹ & بدهی دولت (٪ GDP) & ۴۵٪ & — & قابل مدیریت \\
\rowcolor{gray!10}
۱۰ & ذخایر ارزی & ۲۰-۳۰ میلیارد \$ & — & ناکافی \\
\bottomrule
\end{tabular}
\end{table}
...
% عنوان
\node[font=\large\bfseries] at (0,5) {هشت مشکل ساختاری اقتصاد ایران};

% مشکلات
\node[problem] at (-4,3.5) (p1) {\textbf{۱. وابستگی به نفت}\\ ۳۵٪ بودجه، ۶۰٪ صادرات};
\node[problem] at (4,3.5) (p2) {\textbf{۲. تحریم‌های گسترده}\\ ۳۸۰۰+ تحریم فعال};
\node[problem] at (-4,2) (p3) {\textbf{۳. تورم مزمن}\\ ۴۵-۵۰٪ سالانه};
\node[problem] at (4,2) (p4) {\textbf{۴. فساد سیستماتیک}\\ رتبه ۱۴۹ از ۱۸۰};
\node[problem] at (-4,0.5) (p5) {\textbf{۵. ناکارآمدی بنگاه‌های دولتی}\\ ۴۰٪ اقتصاد دولتی};
\node[problem] at (4,0.5) (p6) {\textbf{۶. نظام بانکی ورشکسته}\\ NPL بالای ۲۰٪};
\node[problem] at (-4,-1) (p7) {\textbf{۷. فرار سرمایه}\\ ۵-۱۰ میلیارد \$/سال};
\node[problem] at (4,-1) (p8) {\textbf{۸. فرار مغزها}\\ ۱۵۰,۰۰۰ نخبه/سال};

% اتصال به مرکز
\node[ellipse, draw=red!70, fill=red!20, thick, minimum width=3cm] at (0,1.2) (center) 
    {\textbf{بحران اقتصادی}};
\foreach \p in {p1,p2,p3,p4,p5,p6,p7,p8} {
    \draw[thick, red!40, dashed] (\p) -- (center);
}
\end{tikzpicture}
\end{center}
...
\label{tab:sanctions}
\begin{tabular}{>{\columncolor{orange!8}}l c p{6cm}}
\toprule
\rowcolor{orange!25}
\textbf{نوع تحریم} & \textbf{تعداد تقریبی} & \textbf{تأثیر اصلی} \\
\midrule
تحریم‌های آمریکا & ۲,۵۰۰+ & قطع از سیستم دلاری، تحریم ثانویه \\
\rowcolor{gray!10}
تحریم‌های اتحادیه اروپا & ۸۰۰+ & محدودیت تجارت، بانکی \\
تحریم‌های سازمان ملل & ۵۰+ & تسلیحاتی، هسته‌ای (بخشی لغو شده) \\
\rowcolor{gray!10}
تحریم‌های سایر کشورها & ۴۰۰+ & کانادا، استرالیا، ژاپن و... \\
\midrule
\textbf{مجموع} & \textbf{۳,۸۰۰+} & قطع از سیستم مالی جهانی \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{>{\columncolor{blue!8}}c p{3.5cm} p{3.5cm} p{3.5cm}}
\toprule
\rowcolor{blue!25}
\textbf{مرحله} & \textbf{اقدام ایران} & \textbf{اقدام طرف مقابل} & \textbf{زمان‌بندی} \\
\midrule
۱ & اعلام پایبندی به NPT، توقف غنی‌سازی بالای ۵٪ & تعلیق تحریم‌های نفتی & ماه ۱-۳ \\
\rowcolor{gray!10}
۲ & پذیرش بازرسی‌های IAEA، شفافیت کامل & رفع تحریم‌های بانکی (SWIFT) & ماه ۳-۶ \\
۳ & امضای پروتکل الحاقی & رفع تحریم‌های تجاری & ماه ۶-۱۲ \\
\rowcolor{gray!10}
۴ & تعهد به عدم توسعه سلاح & رفع تحریم‌های ثانویه آمریکا & ماه ۱۲-۱۸ \\
۵ & بازگشت به برجام+ یا توافق جدید & آزادسازی دارایی‌های بلوکه‌شده & ماه ۱۸-۲۴ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{>{\columncolor{green!8}}r p{4cm} p{5.5cm}}
\toprule
\rowcolor{green!25}
\textbf{ابزار} & \textbf{اقدام} & \textbf{اثر مورد انتظار} \\
\midrule
سیاست پولی & استقلال بانک مرکزی، هدف‌گذاری تورم & توقف چاپ پول برای کسری بودجه \\
\rowcolor{gray!10}
سیاست مالی & کاهش کسری بودجه به زیر ۳٪ GDP & کاهش فشار تقاضا \\
سیاست ارزی & یکسان‌سازی نرخ ارز، شناورسازی مدیریت‌شده & حذف رانت ارزی، ثبات \\
\rowcolor{gray!10}
یارانه‌ها & هدفمندسازی واقعی (نقدی به دهک‌های پایین) & کاهش هزینه دولت، کارایی \\
واردات & تسهیل واردات کالاهای اساسی & افزایش عرضه، کاهش قیمت \\
\rowcolor{gray!10}
ذخایر ارزی & افزایش به ۱۰۰ میلیارد دلار (هدف ۵ ساله) & اعتماد و ثبات ارزی \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{axis}[
    ...
    height=6cm,
    xlabel={ماه},
    ylabel={نرخ تورم (درصد سالانه)},
    xmin=0, xmax=25,
    ymin=0, ymax=55,
    xtick={0,6,12,18,24},
    xticklabels={شروع, ماه ۶, ماه ۱۲, ماه ۱۸, ماه ۲۴},
...
\begin{axis}[
    ...
    ymax=70,
    xtick=data,
    xticklabels={۱۴۰۳, سال ۳, سال ۵, سال ۷, سال ۱۰},
    nodes near coords,
...
\begin{tabular}{>{\columncolor{orange!8}}l p{3cm} c p{4cm}}
\toprule
\rowcolor{orange!25}
\textbf{صنعت} & \textbf{چالش فعلی} & \textbf{سرمایه‌گذاری} & \textbf{هدف} \\
\midrule
خودرو & کیفیت پایین، فناوری قدیمی & ۲۰ میلیارد \$ & مشارکت با برندهای جهانی \\
\rowcolor{gray!10}
پتروشیمی & ظرفیت خام‌فروشی & ۳۰ میلیارد \$ & زنجیره ارزش کامل \\
فولاد & انرژی‌بر، آلاینده & ۱۵ میلیارد \$ & فناوری سبز، صادرات \\
\rowcolor{gray!10}
نساجی & رقابت‌پذیری پایین & ۵ میلیارد \$ & برندسازی، کیفیت \\
غذایی & وابستگی به واردات & ۱۰ میلیارد \$ & خودکفایی، صادرات \\
\rowcolor{gray!10}
دارو و تجهیزات پزشکی & واردات بالا & ۸ میلیارد \$ & تولید داخلی ۸۰٪ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{axis}[
    ...
    ymax=100,
    xtick={1,2,3,4},
    xticklabels={۱۴۰۳ (مبدأ), سال ۵, سال ۱۰, سال ۱۵},
    legend style={
        at={(0.5,-0.15)},
        anchor=north,
        legend columns=3,
...
% نفت خام
\addplot[fill=gray!70, draw=gray!90] coordinates {(1,60) (2,45) (3,30) (4,20)};
% پتروشیمی
\addplot[fill=blue!50, draw=blue!70] coordinates {(1,20) (2,22) (3,22) (4,20)};
% صنایع
\addplot[fill=green!50, draw=green!70] coordinates {(1,10) (2,15) (3,22) (4,25)};
% خدمات و گردشگری
\addplot[fill=orange!50, draw=orange!70] coordinates {(1,5) (2,10) (3,15) (4,20)};
% فناوری و دانش‌بنیان
\addplot[fill=purple!50, draw=purple!70] coordinates {(1,5) (2,8) (3,11) (4,15)};

\legend{نفت خام, پتروشیمی, صنایع, خدمات و گردشگری, فناوری و دانش‌بنیان}
\end{axis}
\end{tikzpicture}
\captionof{figure}{تنوع‌بخشی به سبد صادراتی ایران}
\label{fig:export-diversification}
\end{center}
...
\begin{tabular}{>{\columncolor{teal!8}}r p{2.5cm} p{2.5cm} p{2.5cm} p{2.5cm}}
\toprule
\rowcolor{teal!25}
\textbf{موتور} & \textbf{پتانسیل} & \textbf{هدف سال ۱۵} & \textbf{سرمایه‌گذاری} & \textbf{اشتغال} \\
\midrule
گردشگری & ۵۰ سایت یونسکو، تنوع & ۳۰ میلیون گردشگر & ۵۰ میلیارد \$ & ۳ میلیون \\
\rowcolor{gray!10}
ترانزیت & موقعیت ژئوپلتیک & ۵۰ میلیارد \$ درآمد & ۴۰ میلیارد \$ & ۱ میلیون \\
فناوری اطلاعات & نیروی کار تحصیل‌کرده & ۲۰ میلیارد \$ صادرات & ۱۵ میلیارد \$ & ۱ میلیون \\
\rowcolor{gray!10}
انرژی‌های تجدیدپذیر & آفتاب، باد فراوان & ۱۰ میلیارد \$ صادرات برق & ۸۰ میلیارد \$ & ۵۰۰ هزار \\
کشاورزی مدرن & آب و هوا متنوع & خودکفایی + صادرات & ۳۰ میلیارد \$ & ۲ میلیون \\
\bottomrule
\end{tabular}
\end{table}
...
% نقشه ساده
\draw[thick, fill=blue!10] (0,0) ellipse (6cm and 3cm);
\node[font=\large\bfseries] at (0,2.5) {ایران: هاب ترانزیت منطقه‌ای};

% مسیرها
\node[circle, fill=green!50, minimum size=0.8cm] (n1) at (-5,0) {\scriptsize اروپا};
\node[circle, fill=orange!50, minimum size=0.8cm] (n2) at (5,0) {\scriptsize چین};
\node[circle, fill=blue!50, minimum size=0.8cm] (n3) at (0,2) {\scriptsize روسیه};
\node[circle, fill=red!50, minimum size=0.8cm] (n4) at (0,-2) {\scriptsize هند};
\node[circle, fill=purple!50, minimum size=0.8cm] (n5) at (-3,-1.5) {\scriptsize خلیج فارس};
\node[circle, fill=teal!50, minimum size=0.8cm] (n6) at (3,1.5) {\scriptsize آسیای مرکزی};

% ایران در مرکز
\node[rectangle, rounded corners, fill=yellow!50, minimum width=1.5cm] (iran) at (0,0) {\textbf{ایران}};
...
% کریدورها
\node[font=\scriptsize, below=3.5cm of iran, align=center] {
...
\begin{tabular}{>{\columncolor{purple!8}}l c c p{4cm}}
\toprule
\rowcolor{purple!25}
\textbf{بخش} & \textbf{اشتغال فعلی (م)} & \textbf{هدف سال ۱۰ (م)} & \textbf{راهبرد} \\
\midrule
گردشگری و هتلداری & ۰.۵ & ۳ & زیرساخت، ویزا، بازاریابی \\
\rowcolor{gray!10}
ساختمان و مسکن & ۳ & ۵ & پروژه مسکن ملی \\
صنایع تولیدی & ۴ & ۶ & نوسازی، صادرات‌محور \\
\rowcolor{gray!10}
فناوری اطلاعات & ۰.۳ & ۱.۳ & استارتاپ‌ها، صادرات خدمات \\
کشاورزی مدرن & ۴ & ۴.۵ & مکانیزاسیون، ارزش‌افزوده \\
\rowcolor{gray!10}
خدمات & ۸ & ۱۲ & مالی، بهداشت، آموزش \\
انرژی‌های نو & ۰.۱ & ۰.۵ & تولید و نصب \\
\midrule
\textbf{مجموع} & \textbf{۲۴} & \textbf{۳۴} & \textbf{۱۰ میلیون شغل جدید} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{>{\columncolor{red!8}}r p{4cm} p{5.5cm}}
\toprule
\rowcolor{red!25}
\textbf{محور} & \textbf{اقدام} & \textbf{نتیجه مورد انتظار} \\
\midrule
شفافیت & ثبت الکترونیک همه معاملات دولتی & حذف رانت اطلاعاتی \\
\rowcolor{gray!10}
نظارت & کمیسیون مستقل ضدفساد با اختیارات کامل & بازداشت و محاکمه مفسدان \\
قوانین & قانون «از کجا آورده‌ای» با ضمانت اجرا & مصادره اموال نامشروع \\
\rowcolor{gray!10}
تعارض منافع & ممنوعیت فعالیت اقتصادی مقامات و خانواده & جلوگیری از سوءاستفاده \\
مناقصات & الکترونیکی، علنی، با داوری مستقل & کاهش فساد در قراردادها \\
\rowcolor{gray!10}
حفاظت از گزارشگران & قانون whistleblower، پاداش & تشویق افشاگری \\
مجازات & سلب مصونیت همه مقامات، مجازات سنگین & بازدارندگی \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{axis}[
    ...
    height=6cm,
    xlabel={سال},
    ylabel={رتبه شاخص CPI (از ۱۸۰ کشور)},
    xmin=0, xmax=16,
    ymin=0, ymax=160,
    xtick={0,5,10,15},
    xticklabels={۱۴۰۳, سال ۵, سال ۱۰, سال ۱۵},
    legend pos=north east,
    grid=major,
    grid style={dashed, gray!30},
    y dir=reverse
...
\addplot[color=orange, dashed, thick] coordinates {
    (0, 24) (5, 24) (10, 24) (15, 24)
};

\legend{ایران (هدف), ترکیه (فعلی), امارات (فعلی)}

\node[font=\scriptsize, green!70!black] at (axis cs:12,60) {هدف: رتبه ۴۵};
\end{axis}
\end{tikzpicture}
\captionof{figure}{مسیر بهبود رتبه ایران در شاخص فساد}
\label{fig:corruption-improvement}
\end{center}
