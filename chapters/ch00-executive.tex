...
\begin{figure}[H]
	...
	\begin{tikzpicture}[
		...
		\node[phasebox, fill=blue!60!black, minimum width=1.2cm] at (0.5,1.2) {
			\begin{tabular}{c}
				\rl{فاز ۱}\\[-2pt]
				\scriptsize \rl{گذار}
			\end{tabular}
		};
		\node[phasebox, fill=green!60!black, minimum width=1.8cm] at (2.1,1.2) {
			\begin{tabular}{c}
				\rl{فاز ۲}\\[-2pt]
				\scriptsize \rl{نهادسازی}
			\end{tabular}
		};
		\node[phasebox, fill=orange!80!black, minimum width=2.5cm] 	at (4.5,1.2) {\rl{فاز ۳: تحکیم}};
		\node[phasebox, fill=purple!60!black, minimum width=4.0cm] 	at (8.0,1.2) {\rl{فاز ۴: بلوغ}};
		\node[phasebox, fill=red!70!black, minimum width=2.0cm] at (11.5,1.2) {\rl{فاز ۵: برتری}};
...
\begin{tikzpicture}[
    ...
    node distance=1.5cm,
    timebox/.style={rectangle, rounded corners=3pt, minimum width=3.2cm, minimum height=1.5cm, text centered, draw=bleurepublique, fill=bleulight, line width=1pt},
