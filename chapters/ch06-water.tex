...
\chapterheader{۶}{مدیریت بحران آب}{حیات سرزمین در گرو مدیریت خردمندانه}{EraEarlyMod}
\label{ch:water}
...
% منابع سنتی
\addplot[color=bleurepublique, ultra thick, mark=*] coordinates {
    (1960,1400) (1970,1500) (1980,1600) (1990,1650) (2000,1600) (2010,1500) (2020,1400)
};

% شیرین‌سازی
\addplot[color=goldphoenix, ultra thick, mark=square*] coordinates {
    (1960,0) (1970,0) (1980,0) (1990,0) (2000,50) (2010,300) (2020,700)
};

% بازچرخانی
\addplot[color=goldlight, ultra thick, mark=triangle*] coordinates {
...
% چهار شیر
\node[tapbox, draw=bleurepublique, fill=bleulight] (t1) at (0,0) {\rl{شیر ۱}\\\rl{واردات آب}\\ \tiny \rl{۴۰٪}};
\node[tapbox, draw=goldphoenix, fill=goldlight] (t2) at (4,0) {\rl{شیر ۲}\\\rl{جمع‌آوری باران}\\ \tiny \rl{۲۰٪}};
\node[tapbox, draw=bleurepublique, fill=bleurepublique, text=white] (t3) at (8,0) {\rl{شیر ۳}\\\rl{NEWater}\\ \tiny \rl{۳۰٪}};
\node[tapbox, draw=goldphoenix, fill=goldphoenix, text=white] (t4) at (12,0) {\rl{شیر ۴}\\\rl{شیرین‌سازی}\\ \tiny \rl{۱۰٪}};
...
% قبل
\node[box, draw=rougerevolution, fill=rougelight] (b1) at (0,0) {\rl{قبل از اصلاحات}\\ \tiny \rl{حق نامحدود}};
\node[box, draw=bleurepublique, fill=bleulight] (b2) at (8,0) {\rl{بعد از اصلاحات}\\ \tiny \rl{دارایی قابل معامله}};
