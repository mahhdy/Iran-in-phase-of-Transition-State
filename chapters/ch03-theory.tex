...
\chapterheader{۳}{مبانی نظری}{ساختن بر بنیادهای استوار اندیشه}{EraContemp}
\label{ch:theory}
...
% برچسب‌ها
\node[font=\tiny, text width=1.8cm, align=center, below] at (0,-0.4) {\rl{توتالیتر}\\ \tiny \rl{(کره شمالی)}};
\node[font=\tiny, text width=1.8cm, align=center, below] at (2.8,-0.4) {\rl{اقتدارگرای بسته}\\ \tiny \rl{(عربستان)}};
\node[font=\tiny, text width=1.8cm, align=center, below] at (5.6,-0.4) {\rl{اقتدارگرای رقابتی}\\ \tiny \rl{(روسیه)}};
\node[font=\tiny, text width=1.8cm, align=center, below] at (8.4,-0.4) {\rl{دموکراسی انتخاباتی}\\ \tiny \rl{(هند)}};
\node[font=\tiny, text width=1.8cm, align=center, below] at (11.2,-0.4) {\rl{دموکراسی لیبرال}\\ \tiny \rl{(آلمان)}};
\node[font=\tiny, text width=1.8cm, align=center, below] at (14,-0.4) {\rl{دموکراسی کامل}\\ \tiny \rl{(نروژ)}};
...
\begin{tikzpicture}[
    ...
    roof/.style={
        trapezium,
        trapezium angle=70,
        minimum width=14cm, text width=14cm,
        minimum height=1.5cm,
        draw=goldphoenix,
        fill=goldlight,
        line width=2pt
...
% مدل ترکیبی
\node[mainbox, draw=goldphoenix, fill=goldlight, minimum width=8cm, text width=8cm, minimum height=2.5cm] (hybrid) at (0,0) {
    \begin{tabular}{c}
...
% نتایج
\node[mainbox, draw=bleurepublique, fill=bleurepublique, text=white, minimum width=4cm, text width=4cm] (r1) at (-4,-3) {\textbf{وحدت پایدار}};
\node[mainbox, draw=goldphoenix, fill=goldphoenix, text=white, minimum width=4cm, text width=4cm] (r2) at (4,-3) {\textbf{تنوع شکوفا}};
...
% مرکز
\node[circle, minimum size=2.2cm, text width=2.2cm, draw=goldphoenix, fill=goldphoenix, text=white, font=\small\bfseries] (center) at (0,1) {\rl{آشتی ملی}};
...
% سطح ۲: گذار
\node[mainbox, draw=phase1, fill=phase1!20, minimum width=12cm, text width=12cm] (trans) at (0,3.5) {
...
% سطح ۴: تحکیم
\node[mainbox, draw=phase3, fill=phase3!20, minimum width=12cm, text width=12cm] (cons) at (0,-1.5) {
    \textbf{تحکیم:} نهادینه‌سازی + فرهنگ دموکراتیک + توسعه پایدار
};

% سطح ۵: نتیجه
\node[mainbox, draw=vertnapoleon, fill=vertlight, minimum width=8cm, text width=8cm, minimum height=2cm] (result) at (0,-4.5) {
    \begin{tabular}{c}
