...
\chapterheader{۵}{تجارب ناموفق جهانی}{عبرت از اشتباهات دیگران}{AccentRed}
\label{ch:failure}
...
% نتیجه نهایی
\node[errorbox, draw=rougerevolution, fill=rougerevolution, text=white, minimum width=10cm, text width=10cm, minimum height=1.5cm] (final) at (4.5,-2.5) {\textbf{\rl{بحران امنیتی + فروپاشی اجتماعی + دولت شکننده}}};
...
% قبل
\node[fragbox, draw=gris, fill=grislight] (before) at (0,0) {\rl{لیبی واحد}\\ \tiny \rl{(دوره قذافی)}};
...
\node[eventbox, draw=bleurepublique, fill=bleulight, above] at (3.5,0.5) {\rl{فوریه ۲۰۱۱}\\\rl{سقوط مبارک}};
...
% مراحل
\node[stagebox, draw=bleurepublique, fill=bleulight] (s1) at (0,0) {\rl{۱۹۵۸-۱۹۹۸}\\ \tiny \rl{دموکراسی نفتی}};
\node[stagebox, draw=goldphoenix, fill=goldlight] (s2) at (5,0) {\rl{۱۹۹۹-۲۰۱۳}\\ \tiny \rl{از چاوز تا پوپولیسم}};
\node[stagebox, draw=rougerevolution, fill=rougelight] (s3) at (10,0) {\rl{۲۰۱۳-امروز}\\ \tiny \rl{فروپاشی مادورو}};
