...
\hline
\rowcolor{gray!30}
\textbf{نام منبع} & \textbf{آدرس} & \textbf{محتوا} \\
\hline
\endfirsthead
...
\begin{tikzpicture}
    \node[
        ...
        {\Huge ★}\\[10pt]
        {\Large\textbf{پایان کتاب}}\\[10pt]
        {\large از بحران تا بالندگی}\\[5pt]
        {\normalsize طرح جامع تأسیس و تثبیت دموکراسی پایدار}\\[5pt]
        {\normalsize در جامعه‌ای با میراث تمدنی و تنوع قومی-فرهنگی}\\[15pt]
        {\small مهدی سالم | ریچموندهیل | ۱۴۰۴}
    };
\end{tikzpicture}
\end{center}