...
\begin{tikzpicture}
    ...
    \pie[
        text=legend,
        radius=3,
        color={DemocracyBlue!70, SuccessGreen!70, WisdomGold!70, orange!70, WarningRed!70, purple!70, teal!70, gray!50}
    ]{
        55/فارس,
        20/آذری,
        10/کرد,
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{DemocracyBlue!10}}r|r|r|r|r|r|}
\hline
\rowcolor{DemocracyBlue!30}
\textbf{قوم} & \textbf{جمعیت (میلیون)} & \textbf{درصد} & \textbf{زبان اصلی} & \textbf{دین غالب} & \textbf{استان‌های اصلی} \\
\hline
\endfirsthead
\hline
\rowcolor{DemocracyBlue!30}
...
\textbf{ردیف} & \textbf{استان} & \textbf{جمعیت (میلیون)} & \textbf{مساحت (کیلومتر²)} & \textbf{تراکم} & \textbf{قوم غالب} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{purple!10}}p{3cm}|r|r|r|r|r|}
\hline
\rowcolor{purple!30}
\textbf{منطقه/استان} & \textbf{HDI} & \textbf{امید زندگی} & \textbf{سواد (٪)} & \textbf{درآمد سرانه (\$)} & \textbf{شکاف با میانگین} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{SuccessGreen!10}}p{4cm}|r|r|r|r|r|}
\hline
\rowcolor{SuccessGreen!30}
\textbf{شاخص} & \textbf{۱۳۹۸} & \textbf{۱۳۹۹} & \textbf{۱۴۰۰} & \textbf{۱۴۰۱} & \textbf{۱۴۰۲ (تخمین)} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{WarningRed!10}}p{2.5cm}|r|p{4cm}|p{5cm}|}
\hline
\rowcolor{WarningRed!30}
\textbf{منبع تحریم} & \textbf{تعداد} & \textbf{حوزه‌های اصلی} & \textbf{تأثیر اقتصادی} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{SuccessGreen!10}}p{3cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|}
\hline
\rowcolor{SuccessGreen!30}
\textbf{شاخص} & \textbf{سناریوی حداقلی} & \textbf{سناریوی میانه} & \textbf{سناریوی حداکثری} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{DemocracyBlue!10}}p{4cm}|r|r|r|}
\hline
\rowcolor{DemocracyBlue!30}
\textbf{شاخص} & \textbf{مقدار} & \textbf{واحد} & \textbf{وضعیت} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{DemocracyBlue!10}}r|p{3cm}|r|r|r|p{2.5cm}|}
\hline
\rowcolor{DemocracyBlue!30}
\textbf{ردیف} & \textbf{حوضه آبریز} & \textbf{مساحت (کیلومتر²)} & \textbf{جمعیت (میلیون)} & \textbf{کسری (م³/سال)} & \textbf{وضعیت} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{SuccessGreen!10}}p{3cm}|r|r|r|r|}
\hline
\rowcolor{SuccessGreen!30}
\textbf{پروژه/منطقه} & \textbf{ظرفیت (م³/روز)} & \textbf{هزینه (میلیارد \$)} & \textbf{زمان اجرا} & \textbf{جمعیت بهره‌مند} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{WisdomGold!10}}p{4cm}|r|r|p{3cm}|p{3cm}|}
\hline
\rowcolor{WisdomGold!30}
\textbf{شاخص} & \textbf{رتبه ایران} & \textbf{از کل کشورها} & \textbf{وضعیت} & \textbf{هدف ۱۰ ساله} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{gray!10}}p{2cm}|r|r|r|r|r|r|}
\hline
\rowcolor{gray!30}
\textbf{کشور} & \textbf{جمعیت (م)} & \textbf{GDP (\$ م)} & \textbf{سرانه (\$)} & \textbf{دموکراسی} & \textbf{فساد} & \textbf{HDI} \\
\hline
\endfirsthead
...
\begin{tikzpicture}
    ...
    \node[
        ...
        font=\bfseries,
        minimum width=14cm
    ] at (0,6) {شاخص‌های کلیدی عملکرد (KPI) — اهداف ۲۵ ساله};
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{SuccessGreen!10}}p{2cm}|r|p{2.5cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|}
\hline
\rowcolor{SuccessGreen!30}
\textbf{کشور} & \textbf{سال گذار} & \textbf{نوع رژیم قبلی} & \textbf{محرک گذار} & \textbf{مدت تثبیت} & \textbf{موفقیت کلی} \\
\hline
\endfirsthead
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{WarningRed!10}}p{2cm}|r|p{2.5cm}|p{2.5cm}|p{4cm}|}
\hline
\rowcolor{WarningRed!30}
\textbf{کشور} & \textbf{سال} & \textbf{نوع گذار} & \textbf{نتیجه} & \textbf{علل شکست} \\
\hline
\endfirsthead
...
\begin{tikzpicture}
    ...
    % عناوین
    \node[fill=SuccessGreen, text=white, rounded corners=3pt, font=\bfseries] at (-3.5,3.5) {عوامل موفقیت};
    \node[fill=WarningRed, text=white, rounded corners=3pt, font=\bfseries] at (3.5,3.5) {عوامل شکست};
