...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        xticklabels={\rl{نفت و گاز}, \rl{صنعت}, \rl{خدمات}, \rl{کشاورزی}, \rl{معدن}, \rl{ساختمان}},
        xtick=data,
        ymin=0, ymax=50,
        bar width=20pt,
        nodes near coords,
...
\begin{tikzpicture}
    ...
    \foreach \y/\name/\current/\y5/\y10/\y25 in {
        ...
        % مقادیر
        \node[font=\scriptsize, fill=WarningRed!30, rounded corners=2pt, minimum width=1.5cm, text width=1.5cm] at (-2.5,\y) {\current};
        \node[font=\scriptsize, fill=orange!30, rounded corners=2pt, minimum width=1.5cm, text width=1.5cm] at (-0.5,\y) {\y5};
        \node[font=\scriptsize, fill=WisdomGold!30, rounded corners=2pt, minimum width=1.5cm, text width=1.5cm] at (1.5,\y) {\y10};
        \node[font=\scriptsize, fill=SuccessGreen!30, rounded corners=2pt, minimum width=1.5cm, text width=1.5cm] at (3.5,\y) {\y25};
    }
...
\begin{tikzpicture}
    ...
    \node[
        ...
        rounded corners=10pt,
        minimum width=6.5cm, text width=6.5cm,
        minimum height=8cm,
        align=right
    ] (success) at (-3.5,0) {};
...
\begin{tikzpicture}
    ...
    \node[
        ...
        minimum width=15cm, text width=15cm,
        minimum height=10cm
    ] at (0,0) {};
    
    % عنوان
    \node[fill=DemocracyBlue, text=white, rounded corners=5pt, font=\large\bfseries, minimum width=10cm, text width=10cm] at (0,4.5) {داشبورد ملی پایش گذار دموکراتیک};
