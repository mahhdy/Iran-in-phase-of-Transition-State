...
\begin{longtable}{|>{\columncolor{DemocracyBlue!10}}p{3.5cm}|p{3cm}|p{7.5cm}|}
\hline
...
\begin{longtable}{|>{\columncolor{SuccessGreen!10}}p{3.5cm}|p{3cm}|p{7.5cm}|}
\hline
...
\begin{longtable}{|>{\columncolor{WisdomGold!10}}p{3.5cm}|p{3cm}|p{7.5cm}|}
\hline
...
\begin{longtable}{|>{\columncolor{purple!10}}p{3.5cm}|p{3cm}|p{7.5cm}|}
\hline
\rowcolor{purple!30}
\textbf{اصطلاح فارسی} & \textbf{معادل انگلیسی} & \textbf{تعریف} \\
\hline
