...
\begin{tikzpicture}[
    ...
    centernode/.style={
        ...
        fill=bleulight,
        line width=2pt,
        minimum size=3.5cm, text width=3.5cm,
        align=center,
        font=\large\bfseries
    },
    leafnode/.style={
...
\begin{tikzpicture}[
    ...
    label/.style={
        ...
        rounded corners=5pt,
        font=\large\bfseries,
        minimum width=6cm, text width=6cm
    }
]
\node[box] (main) at (0,0) {};
...
\begin{tikzpicture}[scale=0.9]
    ...
    % کشورها
    \node[circle, draw=DemocracyBlue, fill=DemocracyBlue!30, minimum size=1.2cm, text width=1.2cm, font=\tiny] at (8,5.5) {ایران};
    \node[circle, draw=SuccessGreen, fill=SuccessGreen!30, minimum size=1cm, text width=1cm, font=\tiny] at (3,5) {آلمان};
    \node[circle, draw=WisdomGold, fill=WisdomGold!30, minimum size=1cm, text width=1cm, font=\tiny] at (10,4.5) {هند};
    \node[circle, draw=purple, fill=purple!30, minimum size=1cm, text width=1cm, font=\tiny] at (7,3.5) {اسپانیا};
    \node[circle, draw=orange, fill=orange!30, minimum size=1cm, text width=1cm, font=\tiny] at (9,4) {آفریقا};
    \node[circle, draw=WarningRed, fill=WarningRed!30, minimum size=1cm, text width=1cm, font=\tiny] at (5,6) {سوئیس};
    \node[circle, draw=gray, fill=gray!30, minimum size=1cm, text width=1cm, font=\tiny] at (4,2) {فرانسه};
