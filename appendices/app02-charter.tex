...
\begin{tikzpicture}
    ...
    \node[
        ...
        rounded corners=5pt,
        font=\large\bfseries,
        minimum width=8cm, text width=8cm
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[
        ...
        fill=gray!20,
        circle,
        minimum size=1.5cm, text width=1.5cm,
        font=\small\bfseries
    ] at (0,0) {\rl{تهران}};
\end{tikzpicture}
\end{center}
...
\begin{enghelabbox}
\textbf{ (!)  اقدامات ممنوع علیه اقوام}
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[
        ...
        font=\tiny,
        align=center,
        minimum width=1.8cm, text width=1.8cm
