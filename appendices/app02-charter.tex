...
\begin{tikzpicture}
    ...
    \node[
        ...
        \begin{center}
            {\Huge\textbf{منشور حقوق اقوام}}\\[5pt]
            {\LARGE\textbf{جمهوری فدرال ایران}}\\[10pt]
            {\large ضمیمه قانون اساسی | دارای قوت قانون اساسی}
        \end{center}
    };
    
    % نماد تنوع
    \foreach \i/\color in {1/DemocracyBlue, 2/SuccessGreen, 3/WisdomGold, 4/WarningRed, 5/purple, 6/orange} {
...
\begin{longtable}{|>{\columncolor{purple!15}}p{3cm}|p{11cm}|}
\hline
\rowcolor{purple!30}
...
\textbf{قوم} & گروهی از شهروندان که دارای ویژگی‌های مشترک زبانی، فرهنگی، تاریخی یا سرزمینی هستند و خود را متعلق به آن گروه می‌دانند. \\
\hline

\textbf{زبان ملی} & زبانی که توسط یکی از اقوام اصلی ایران به عنوان زبان مادری استفاده می‌شود و در این منشور به رسمیت شناخته شده است. \\
\hline

\textbf{منطقه خودمختار} & واحد سرزمینی که طبق قانون اساسی از درجه‌ای از خودمختاری در امور داخلی برخوردار است. \\
\hline

\textbf{سرزمین تاریخی} & منطقه‌ای که یک قوم به‌طور سنتی و تاریخی در آن ساکن بوده است. \\
\hline

\textbf{حقوق جمعی} & حقوقی که به یک گروه قومی به‌عنوان یک کلیت تعلق دارد. \\
\hline

\textbf{حقوق فردی} & حقوقی که به هر فرد عضو یک قوم تعلق دارد. \\
\hline

\textbf{تبعیض مثبت} & اقدامات موقت برای جبران نابرابری‌های تاریخی و ایجاد برابری واقعی. \\
\hline

\textbf{همسان‌سازی اجباری} & هرگونه سیاست یا اقدام برای از بین بردن هویت قومی یا فرهنگی. \\
\hline
...
\begin{tikzpicture}[
    ...
    \node[
        ...
        font=\large\bfseries,
        minimum width=10cm
    ] at (0,5) {اقوام اصلی ایران};
    
    % ردیف اول
    \node[ethnicity=DemocracyBlue] at (-5,3) {\shortstack{فارس\\≈۵۵٪}};
    \node[ethnicity=SuccessGreen] at (-2,3) {\shortstack{آذری\\≈۲۰٪}};
    \node[ethnicity=WisdomGold] at (1,3) {\shortstack{کرد\\≈۱۰٪}};
    \node[ethnicity=orange] at (4,3) {\shortstack{لر\\≈۶٪}};
    
    % ردیف دوم
    \node[ethnicity=WarningRed] at (-4,0.5) {\shortstack{عرب\\≈۳٪}};
    \node[ethnicity=purple] at (-1,0.5) {\shortstack{بلوچ\\≈۲٪}};
    \node[ethnicity=teal] at (2,0.5) {\shortstack{ترکمن\\≈۱٪}};
    \node[ethnicity=gray] at (5,0.5) {\shortstack{گیلک و مازنی\\≈۳٪}};
    
    % یادداشت
    \node[font=\scriptsize, text=gray] at (0,-1.5) {* درصدها تخمینی است. هر فرد می‌تواند هویت چندگانه داشته باشد.};
\end{tikzpicture}
\end{center}

\begin{longtable}{|>{\columncolor{purple!10}}p{2cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
\hline
\rowcolor{purple!30}
\textbf{قوم} & \textbf{زبان اصلی} & \textbf{سرزمین تاریخی} & \textbf{جمعیت تخمینی} & \textbf{وضعیت} \\
\hline
\endfirsthead
\hline
\rowcolor{purple!30}
...
فارس & فارسی & فلات مرکزی، خراسان، فارس & ≈۴۷ میلیون & قوم اکثریت \\
\hline

آذری & ترکی آذربایجانی & آذربایجان شرقی و غربی، اردبیل، زنجان & ≈۱۷ میلیون & منطقه خودمختار \\
\hline

کرد & کردی (سورانی، کرمانجی) & کردستان، کرمانشاه، ایلام، آذربایجان غربی & ≈۸.۵ میلیون & منطقه خودمختار \\
\hline

لر & لری (لکی، بختیاری) & لرستان، چهارمحال، کهگیلویه، خوزستان & ≈۵ میلیون & حقوق ویژه \\
\hline

عرب & عربی & خوزستان & ≈۲.۵ میلیون & منطقه خودمختار \\
\hline

بلوچ & بلوچی & سیستان و بلوچستان & ≈۱.۷ میلیون & منطقه خودمختار \\
\hline

ترکمن & ترکمنی & گلستان (ترکمن‌صحرا) & ≈۸۵۰ هزار & منطقه خودمختار \\
\hline

گیلک & گیلکی & گیلان & ≈۳ میلیون & حقوق ویژه \\
\hline

مازندرانی & مازندرانی & مازندران & ≈۳ میلیون & حقوق ویژه \\
\hline

\multicolumn{5}{l}{\scriptsize سایر گروه‌های قومی-زبانی (تات، تالش، قشقایی، و غیره) نیز از حمایت این منشور برخوردارند.} \\
...
\begin{tikzpicture}
    ...
    \node[
        ...
        font=\large\bfseries,
        minimum width=8cm
    ] at (0,4) {حقوق فردی اعضای اقوام};
    
    % دسته‌بندی حقوق
    \foreach \i/\title/\items in {
        1/{حق هویت}/{انتخاب آزادانه، ثبت هویت قومی، عدم اجبار},
        2/{حق زبان}/{استفاده آزاد، آموزش، خدمات دولتی},
        3/{حق فرهنگ}/{مشارکت، حفظ سنت‌ها، دسترسی},
        4/{حق عدم تبعیض}/{برابری در استخدام، آموزش، خدمات}
    } {
        \node[
...
۵.۱ & هر فرد حق دارد آزادانه هویت قومی خود را تعیین کند، اعلام کند یا اعلام نکند. \\
\hline

۵.۲ & هیچ‌کس را نمی‌توان به پذیرش یا انکار هویت قومی خاصی مجبور کرد. \\
\hline

۵.۳ & هر فرد می‌تواند هویت قومی چندگانه داشته باشد (مثلاً فرزند خانواده کرد-فارس). \\
\hline

۵.۴ & ثبت هویت قومی در اسناد رسمی اختیاری است و تنها برای مقاصد آماری و با رضایت فرد انجام می‌شود. \\
\hline

۵.۵ & هیچ پیامد منفی حقوقی، اداری یا اجتماعی نباید بر اعلام یا عدم اعلام هویت قومی مترتب شود. \\
\hline
...
۷.۱ & هر فرد حق دارد در زندگی فرهنگی قوم خود مشارکت کند. \\
\hline

۷.۲ & هر فرد حق دارد آداب، رسوم و مراسم قومی خود را برگزار کند. \\
\hline

۷.۳ & هر فرد حق دارد لباس سنتی قومی خود را بپوشد. \\
\hline

۷.۴ & هر فرد حق دارد به میراث فرهنگی قوم خود دسترسی داشته باشد. \\
\hline

۷.۵ & هر فرد حق دارد تاریخ و ادبیات قوم خود را بیاموزد و بیاموزاند. \\
\hline
...
\begin{tikzpicture}
    ...
    \foreach \angle/\title in {
        ...
        \draw[->, thick, SuccessGreen!60] (center) -- (\angle:2.8cm);
    }
\end{tikzpicture}
\end{center}
...
۱۲.۱ & هر قوم حق بهره‌مندی عادلانه از منابع ملی را دارد. \\
\hline

۱۲.۲ & مناطق قومی محروم حق دریافت منابع جبرانی برای توسعه را دارند. \\
\hline

۱۲.۳ & منابع طبیعی واقع در سرزمین یک قوم، متعلق به کل ملت است اما آن منطقه سهم ویژه‌ای دریافت می‌کند. \\
\hline

۱۲.۴ & پروژه‌های توسعه در مناطق قومی باید با مشارکت و رضایت جوامع محلی انجام شود. \\
\hline

۱۲.۵ & جابجایی اجباری جمعیت از سرزمین‌های سنتی ممنوع است مگر در شرایط اضطراری و با جبران کامل. \\
\hline
...
\begin{tikzpicture}
    ...
    \node[
        ...
        minimum height=1.5cm,
        font=\bfseries
    ] (l1) at (0,3) {زبان فارسی: زبان رسمی مشترک سراسری};
    ...
    \node[
        ...
        minimum height=1.5cm,
        font=\bfseries
    ] (l2) at (0,1) {زبان‌های ملی: رسمی در مناطق مربوطه};
    ...
    \node[
        ...
        minimum height=1.5cm,
        font=\small
    ] (l3) at (0,-1) {زبان‌های محلی و گویش‌ها: حمایت و حفاظت};
    
    % فهرست زبان‌ها
    \node[font=\scriptsize, align=center] at (0,0) {آذری | کردی | عربی | بلوچی | ترکمنی | لری | گیلکی | مازندرانی};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{small}
\begin{longtable}{|>{\columncolor{WisdomGold!10}}p{3cm}|p{4cm}|p{4cm}|p{3cm}|}
\hline
\rowcolor{WisdomGold!30}
\textbf{حوزه} & \textbf{مناطق خودمختار} & \textbf{مناطق مختلط} & \textbf{سایر مناطق} \\
\hline
\endfirsthead

اسناد هویتی & دوزبانه (فارسی + محلی) & دوزبانه به درخواست & فارسی \\
\hline

تابلوها و علائم & دوزبانه اجباری & دوزبانه در شهرهای بزرگ & فارسی \\
\hline

خدمات اداری & دوزبانه & مترجم در دسترس & فارسی + مترجم \\
\hline

دادگاه‌ها & دوزبانه & مترجم رایگان & مترجم رایگان \\
\hline

بهداشت و درمان & دوزبانه & مترجم بهداشتی & مترجم در دسترس \\
\hline

رسانه عمومی & شبکه محلی به زبان قومی & برنامه‌های چندزبانه & برنامه‌های زبان‌های ملی \\
\hline
...
\begin{tikzpicture}[scale=0.9]
    ...
    \draw[thick, DemocracyBlue, fill=DemocracyBlue!10, rounded corners=10pt] 
        (-6,-3) rectangle (6,4);
    
    % عنوان
    \node[font=\large\bfseries] at (0,3.5) {مناطق خودمختار جمهوری فدرال ایران};
    
    % مناطق (شماتیک)
    \node[
        draw=SuccessGreen,
        fill=SuccessGreen!30,
        rounded corners=5pt,
        minimum width=2.5cm,
        minimum height=1.5cm,
        align=center,
        font=\small
    ] at (-4,1.5) {\textbf{آذربایجان}\\تبریز};
    ...
    \node[
        ...
        align=center,
        font=\small
    ] at (-1.5,1.5) {\textbf{کردستان}\\سنندج};
    ...
    \node[
        ...
        align=center,
        font=\small
    ] at (2,1.5) {\textbf{ترکمن‌صحرا}\\گنبد};
...
۲۱.۱ & هر قوم حق زندگی در سرزمین تاریخی خود را دارد. \\
\hline

۲۱.۲ & تغییر ترکیب جمعیتی عمدی مناطق قومی (مهندسی جمعیتی) ممنوع است. \\
\hline

۲۱.۳ & جابجایی اجباری جمعیت از سرزمین‌های سنتی ممنوع است مگر در موارد اضطراری طبیعی و با جبران کامل و حق بازگشت. \\
\hline

۲۱.۴ & مرزهای مناطق خودمختار تنها با رضایت ساکنان (همه‌پرسی) قابل تغییر است. \\
\hline

۲۱.۵ & شهروندان همه اقوام حق سکونت در هر نقطه از کشور را دارند. \\
\hline
